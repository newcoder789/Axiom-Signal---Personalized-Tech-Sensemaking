...
export const AssistantBoard: React.FC = () => {
        ...
        return (
            <div className="card glass mt-4 p-4 animate-fade-in" style={{ maxHeight: "400px", overflowY: "auto", border: "1px solid var(--accent-gold-muted)" }}>
                ...
                <div className="body-secondary" style={{ fontSize: "13px", lineHeight: "1.6" }}>
                    ...
                    {lastResult.actions && lastResult.actions.length === 0 && <p className="caption italic">No specific actions identified.</p>}
                    {lastResult.review && (
                        <div>
    ...
    return (
        <div className="animate-fade-in" style={{
            ...
            {error && (
                <div className="card" style={{ background: "rgba(255,50,50,0.05)", border: "1px solid rgba(255,50,50,0.1)", padding: "12px", color: "var(--accent-red)", fontSize: "12px", borderRadius: "8px" }}>
            ...
            <div style={{ marginTop: "auto", paddingTop: "20px" }}>
                <div className="card glass-premium" style={{ padding: "12px" }}>
